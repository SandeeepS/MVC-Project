...
const adminAuthenticated =require('../middleware/middleware');
...
//admin operations
route.get('/updateUserData/:id',adminAuthenticated,adminController.updateUserData);
route.post('/updateUser/:id',adminController.updatedUser)
route.get('/createUser',adminAuthenticated,adminController.createUser);
